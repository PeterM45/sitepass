...
A minor (not patch) release: the CLI's env-file parsing and argument
validation changed behavior deliberately (see the upgrade notes under Fixed),
so `^0.2` consumers do not pick it up automatically.
...
[0.3.0]: https://github.com/PeterM45/sitepass/releases/tag/v0.3.0
